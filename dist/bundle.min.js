...
document.addEventListener('DOMContentLoaded', function () {
  ...
  var inputElement = document.querySelector('#category');
  var inputPairs = document.querySelector('#pairs');
  var board = document.querySelector('#board');

  var startGame = function startGame() {
    var game = new _table__WEBPACK_IMPORTED_MODULE_0__.default(inputPairs, inputElement, board);
    store = new _store__WEBPACK_IMPORTED_MODULE_1__.default(board);
  };
...
var Card = /*#__PURE__*/function () {
  ...
  _createClass(Card, [{
    ...
    key: "stopClicking",
    value: function stopClicking() {
      this.card.classList.add('stop-clicking');
    }
  }, {
    key: "addToStore",
    value: function addToStore() {
      this.removeOverlay();
      this.stopClicking();
      _app__WEBPACK_IMPORTED_MODULE_0__.store.clickedCards.push(this);
      _app__WEBPACK_IMPORTED_MODULE_0__.store.isTwoCards();
    }
  }]);
...
var Store = /*#__PURE__*/function () {
  ...
  _createClass(Store, [{
    key: "isTwoCards",
    value: function isTwoCards() {
      var _this = this;

      if (this.clickedCards.length == 2) {
        this.board.classList.add('stop-clicking');
        setTimeout(function () {
          _this.checkCards(_this.clickedCards[0], _this.clickedCards[1]);
        }, 1000);
      } else {
        return false;
      }
    ...
    value: function match() {
      ...
      this.clickedCards.forEach(function (card) {
        _this2.matched.push(card);
    ...
    key: "checkCards",
    value: function checkCards(card1, card2) {
...
/* harmony import */ var _apiKey_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./apiKey.js */ "./js/apiKey.js");
...
var Table = /*#__PURE__*/function () {
  function Table(pairsInputElement, categoryInputElement, tableWrapper) {
  ...
  _createClass(Table, [{
    ...
    key: "renderCards",
    value: function () {
      var _renderCards = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
        var _this = this;
        ...
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return this.getImages(this.category, this.pairs / 2);

              case 2:
                _context.next = 4;
                return this.shuffleCart(this.images);
    ...
    key: "generateCards",
    value: function () {
      var _generateCards = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
        var i;
            ...
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                for (i = 0; i < this.pairs; i++) {
                  this.card = new _card_js__WEBPACK_IMPORTED_MODULE_0__.default(this.images[i]);
                  this.allCards.push(this.card);
                  _app__WEBPACK_IMPORTED_MODULE_2__.store.allCards.push(this.card);
                }

                return _context2.abrupt("return", this.allCards);
    ...
    key: "getImages",
    value: function () {
      var _getImages = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(query, totalRequests) {
        var _this2 = this;
        ...
        return regeneratorRuntime.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                _context3.next = 2;
                return _apiKey_js__WEBPACK_IMPORTED_MODULE_1__.default.photos.search({
                  query: query,
                  per_page: totalRequests
                }).then(function (photos) {
                  _this2.images = [];
                  photos.photos.forEach(function (element) {
                    _this2.images.push(element.src.medium);

                    _this2.images.push(element.src.medium);
                  });
                  return _this2.images;
                });
    ...
    key: "render",
    value: function () {
      var _render = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4() {
        var _this3 = this;
          ...
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                ...
                this.allCards.forEach(function (element) {
                  _this3.board.appendChild(element.card);
                });
    ...
    value: function addOverlays() {
      this.allCards.forEach(function (singleCard) {
